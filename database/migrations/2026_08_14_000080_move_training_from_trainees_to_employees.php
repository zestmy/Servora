    ...
    public function up(): void
    {
        ...
        foreach (array_keys(self::TABLES) as $table) {
            Schema::table($table, function (Blueprint $t) {
                $t->foreignId('employee_id')->nullable()->after('company_id')
