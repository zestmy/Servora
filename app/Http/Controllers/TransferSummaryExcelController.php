...
/**
 * The same transfer summary as a workbook, via the shared GroupSummaryExcelWriter.
 *
 * Extends the PDF controller so both are built from one load() — see
 * WastageSummaryExcelController for the same reasoning.
 */
class TransferSummaryExcelController extends TransferSummaryController
{
    public function __invoke(Request $request)
    {
        ...
        $filename    = 'Transfer-Summary-' . $data['scope']['from'] . '-to-' . $data['scope']['to'] . '.xlsx';
