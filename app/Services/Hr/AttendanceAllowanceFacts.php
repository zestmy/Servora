 ...
 *
 * Any of the last three forfeits an attendance allowance.
 */
class AttendanceAllowanceFacts
{
    public const EMPTY = ['working_days' => 0, 'mc_days' => 0, 'absent_days' => 0, 'late_days' => 0];

    /**
     * @param  array<int, int>  $employeeIds
     * @return array<int, array{working_days: int, mc_days: int, absent_days: int, late_days: int}>
