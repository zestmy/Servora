...
class OtApprovers extends Component
{
    ...
    public function addApprover(): void
    {
        ...
        if ($exists) {
            session()->flash('error', 'This user is already an approver for the selected outlet.');
            return;
        }
    ...
    {
        $approvers = OvertimeClaimApprover::with(['user', 'outlet'])
        ...
        return view('livewire.settings.ot-approvers', compact('approvers', 'users', 'outlets'))
