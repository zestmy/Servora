...
class Index extends Component
{
    ...
    private function companyGroups($user, bool $isBusinessLevel): array
    {
        ...
        // Slug: outlet-audits. Audit forms and schedules have their own nav
        // group; this is the settings-shaped part — who the auditors are.
        $groups[] = [
            'label' => 'Outlet Audits',
            'note'  => 'Who conducts audits, and the forms they conduct them against.',
            'tiles' => [
                [
                    'label' => 'Appointed Auditors',
                    'note'  => 'The people an audit form\'s “Appointed auditor” field offers',
                    'route' => 'audits.auditors',
                    'can'   => 'audits.manage',
                    ...
                    'count' => [\App\Models\AuditAuditor::count(), 'auditor'],
                ],
                [
                    'label' => 'Audit Forms',
                    'note'  => 'The checklists, their sections, items and points',
                    'route' => 'audits.templates',
                    'can'   => 'audits.manage',
                    'icon'  => 'M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15a2.25 2.25 0 012.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25z',
                    'count' => [\App\Models\AuditTemplate::count(), 'form'],
                ],
            ],
        ];
