        ...
        <tr>
            ...
            <td>
                <table class="hero-info">
                    ...
                    @endphp
                    @php
                        // Prep batch sizes (recipe multiples) — quantities side by side.
                                    ...
                                    @if ($sopHasBatches)
                                        <tr>
                                            ...
                                            @foreach ($sopBatchCols as $m)
                                                <td class="ing-qty" style="font-size:6.5pt; font-weight:bold; text-transform:uppercase; letter-spacing:0.5px; color:{{ abs($m - 1.0) < 0.0001 ? '#0752c7' : '#6b7280' }};">
                                    ...
                                    @foreach ($ingredientLines as $line)
                                        <tr>
                                            ...
                                            @foreach ($sopBatchCols as $m)
                                                ...
                                                <td class="ing-qty" @if ($sopHasBatches && abs($m - 1.0) < 0.0001) style="background:#edf4ff;" @endif>{{ $disp['main_qty'] }} {{ $disp['main_uom'] }}@if ($disp['ref_qty'] !== null) <span style="color:#9ca3af;">({{ $disp['ref_qty'] }} {{ $disp['ref_uom'] }})</span>@endif</td>
                                            @endforeach
                                        </tr>
                                    @endforeach
                                </table>
