...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* gray-500, the floor on white: the gray-400 this used was 2.54:1. */
...
<body>
    <div class="card">
        ...
        <p>The system is off the menu briefly while we plate up some new features. We&rsquo;ll be back on the pass shortly.</p>
        <p class="hint">We&rsquo;ll call your order when it&rsquo;s ready. The page auto-refreshes.</p>
    </div>
</body>
</html>
