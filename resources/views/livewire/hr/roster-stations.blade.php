    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
        <div>
            <p class="page-eyebrow">HR / Duty Roster / Settings</p>
                <h1 class="page-title mt-1">Roster Stations</h1>
            ...
            <table class="table-surface min-w-full">
                ...
                <tbody>
                    @forelse ($stations as $station)
                        <tr class="{{ !$station->is_active ? 'bg-gray-50 text-gray-600' : '' }}">
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3 text-center">
                                <button wire:click="toggleActive({{ $station->id }})"
                                        class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full
                                               {{ $station->is_active ? 'bg-success-100 text-success-700' : 'bg-gray-100 text-gray-500' }}">
        ...
        <div class="relative min-h-full flex items-start sm:items-center justify-center p-4">
            <div class="relative bg-white rounded-xl shadow-xl w-full max-w-md" @click.stop>
                ...
                <form wire:submit.prevent="save" class="p-5 space-y-3">
                    <div>
                        <label class="text-xs font-semibold text-gray-600">Station Name <span class="text-danger-500">*</span></label>
                    ...
                    <div>
                        ...
                        @error('f_description') <span class="text-xs text-danger-500 mt-1">{{ $message }}</span> @enderror
                    </div>
