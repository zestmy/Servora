                    ...
                    @foreach ($assignments as $a)
                        <div wire:key="assign-{{ $a->id }}" class="px-3 py-2 flex flex-wrap items-center gap-x-3 gap-y-1 {{ $a->isCurrent() ? '' : 'opacity-60' }}">
                            ...
                            <div class="ml-auto flex items-center gap-1">
                                ...
                                <button wire:click="removeAssignment({{ $a->id }})" data-confirm-delete="Remove this from the employee?" class="text-danger-400 hover:text-danger-600 p-1" title="Remove">
