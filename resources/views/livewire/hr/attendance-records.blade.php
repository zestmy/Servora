<div>
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            {{-- The pool has its own page now; a way there from where it used
                 to be, for the people who may run it. --}}
            @can('hr.attendance.service_charge')
                <a href="{{ route('hr.service-charge') }}"
                   class="px-2.5 md:px-3 py-2 text-sm font-medium rounded-lg transition flex items-center gap-1.5 border text-teal-700 border-teal-200 hover:bg-teal-50">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
