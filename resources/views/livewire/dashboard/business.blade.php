...
<div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 mb-6">
    ...
    <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100">
        ...
        <div class="mt-1 text-2xl font-bold {{ $pendingPOs > 0 ? 'text-warning-600' : 'text-gray-900' }}">{{ $pendingPOs }}</div>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100">
    ...
    <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100">
        ...
        <div class="mt-1 text-2xl font-bold text-success-600">{{ number_format($monthRevenue, 0) }}</div>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100">
        <div class="text-xs font-medium text-gray-500 uppercase tracking-wide">Month Purchases</div>
        <div class="mt-1 text-2xl font-bold text-danger-600">{{ number_format($monthPurchases, 0) }}</div>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-100">
