...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="card p-6">
        ...
        <div class="space-y-3">
            <a href="{{ route('purchasing.orders.create') }}" class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-brand-300 hover:bg-brand-50 transition text-sm">
                <span class="text-lg">🛒</span>
                <span class="font-medium text-gray-700">New Purchase Order</span>
            </a>
            <a href="{{ route('sales.create') }}" class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-brand-300 hover:bg-brand-50 transition text-sm">
                <span class="text-lg">💰</span>
