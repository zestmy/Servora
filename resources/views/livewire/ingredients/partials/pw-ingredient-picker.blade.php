...
<button type="button"
        ...
        class="mt-1 inline-flex items-center gap-1 px-2 py-0.5 text-[11px] rounded border border-gray-200 bg-white hover:bg-brand-50 hover:border-brand-300 transition">
