<div>
    ...
    {{-- Referral Program --}}
    <div class="mt-8">
        <h2 class="text-lg font-bold text-gray-800 mb-1">Refer & Earn</h2>
        <p class="text-xs text-gray-400 mb-4">Share Servora with other F&B businesses and earn commission on every signup.</p>
