<div>
    {{-- Back --}}
    <div class="mb-6">
        <a data-back href="{{ route('lms.dashboard', array_filter(['search' => $backSearch, 'categoryFilter' => $backCategoryFilter], fn ($v) => $v !== '' && $v !== null)) }}" class="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700 transition">
