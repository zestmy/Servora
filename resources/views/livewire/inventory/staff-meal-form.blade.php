<div>
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div class="flex-1 min-w-0">
            <p class="text-xs text-gray-600">
                ...
                / {{ $recordId ? 'Edit Staff Meal Record' : 'New Staff Meal Entry' }}
            </p>
        </div>
            ...
            <div class="card p-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <x-text-input id="sm_date" wire:model="meal_date" type="date" class="mt-1 block w-full" />
                        <x-input-error :messages="$errors->get('meal_date')" class="mt-1" />
                    </div>
                    <div>
                        <x-input-label for="sm_ref" value="Reference" />
                        <x-text-input id="sm_ref" wire:model="reference_number" type="text"
                                      class="mt-1 block w-full" placeholder="e.g. Lunch Staff Meal" />
                    </div>
                </div>
            ...
            <div class="card p-6 lg:sticky lg:top-6">
                ...
                <div class="mt-4 pt-4 border-t border-gray-100">
                    <p class="text-xs text-gray-600 leading-relaxed">
                        Staff meal costs are tracked as reference only and do <strong>not</strong> affect overall COGS calculation.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="mt-4 card">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <div>
                <h3 class="text-sm font-semibold text-gray-700">Staff Meal Items</h3>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        @foreach ($lines as $idx => $line)
                            <tr class="hover:bg-gray-50 transition group">
                                ...
                                <td class="px-4 py-2 text-right tabular-nums font-semibold text-purple-600">
        ...
        @else
            <div class="px-6 py-12 text-center text-gray-600">
                ...
                <p class="text-xs mt-1">Search for ingredients or recipes above to record staff meals.</p>
            </div>
        @endif
