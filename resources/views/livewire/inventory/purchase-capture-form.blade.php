<div>
    ...
    <div class="flex items-center gap-3 mb-6">
        <a data-back href="{{ route('inventory.index', ['tab' => 'purchases']) }}" class="text-gray-600 hover:text-gray-900 transition flex-shrink-0">
        ...
        <div class="lg:col-span-2">
            <div class="card p-6 space-y-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-600">Enter the total purchase amount for this department.</p>
