            ...
            if (el1) {
                chartInstances.rev = new Chart(el1.getContext('2d'), {
                    ...
                    data: {
                        ...
                        datasets: [
                            { label: 'Revenue (RM)', data: dailySales.map(d => d.revenue), borderColor: '#2563eb', backgroundColor: 'rgba(37,99,235,0.1)', fill: true, tension: 0.3, yAxisID: 'y' },
            ...
            if (el2) {
                chartInstances.dow = new Chart(el2.getContext('2d'), {
                    ...
                    data: {
                        ...
                        datasets: [
                            { label: 'Avg Revenue', data: dayOfWeek.map(d => d.avg_revenue), backgroundColor: 'rgba(37,99,235,0.7)', borderRadius: 4, yAxisID: 'y' },
            ...
            if (el6 && mom.current) {
                chartInstances.mom = new Chart(el6.getContext('2d'), {
                    ...
                    data: {
                        ...
                        datasets: [
                            { label: 'Current', data: [mom.current.revenue, mom.current.cogs, mom.current.wastage, mom.current.staff_meals], backgroundColor: 'rgba(37,99,235,0.8)', borderRadius: 4 },
