<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="page-title">Stock Balance (Product)</h2>
            <p class="text-xs text-gray-600 mt-0.5">Ingredient balances with opening, movements, and closing values</p>
        </div>
            ...
            <tbody>
                @forelse ($items as $item)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 text-right tabular-nums text-success-600">{{ number_format($item->purchases_qty, 2) }}</td>
                        ...
                        <td class="px-4 py-3 text-right tabular-nums text-danger-600">{{ number_format($item->wastage_qty, 2) }}</td>
