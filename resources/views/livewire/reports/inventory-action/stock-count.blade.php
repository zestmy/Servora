<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="page-title">Stock Count</h2>
            <p class="text-xs text-gray-600 mt-0.5">Stock take records and their completion status</p>
        </div>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 text-center">
                            <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium
                                {{ $record->status === 'completed' ? 'bg-success-100 text-success-700' : ($record->status === 'in_progress' ? 'bg-yellow-100 text-yellow-700' : 'bg-gray-100 text-gray-600') }}">
