<div>
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div class="flex-1">
            <p class="text-xs text-gray-600"><a href="{{ route('purchasing.index') }}" class="hover:underline">Purchasing</a> / Suppliers</p>
        </div>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <button wire:click="toggleActive({{ $supplier->id }})"
                                        ...
                                        class="{{ $supplier->is_active ? 'text-success-500 hover:text-success-700' : 'text-gray-600 hover:text-gray-900' }} transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                </button>
                                <button wire:click="delete({{ $supplier->id }})"
                                        data-confirm-delete="Delete '{{ $supplier->name }}'? This cannot be undone."
                                        title="Delete"
