        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-start gap-4 mb-5">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-0.5">Transactional email service for sending PO approval emails to suppliers, approvers, and CC recipients.</p>
                </div>
            </div>
            ...
            @else
                <div class="mt-3 flex items-center gap-1.5 text-xs text-amber-600">
                    ...
                    No API key set — PO email notifications will not be sent
                </div>
            @endif
        </div>
