                    ...
                    <div class="p-5 flex items-start justify-between">
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-3">
                                <h3 class="text-sm font-semibold text-gray-700">{{ $kitchen->name }}</h3>
                                @if ($kitchen->code)
                            ...
                            <div class="flex flex-wrap gap-4 mt-2 text-xs text-gray-400">
                                ...
                                @endif
                                @if ($kitchen->contact_person)
                                    <span>{{ $kitchen->contact_person }}</span>
                                @endif
                                @if ($kitchen->email)
    ...
    <div class="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto p-4" x-data>
        ...
        <div class="relative bg-white rounded-xl shadow-xl w-full max-w-lg z-10 p-6 mt-8 mb-8">
            <h3 class="text-lg font-semibold text-gray-700 mb-4">
                {{ $editId ? 'Edit' : 'New' }} Central Kitchen
            </h3>
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="code" class="w-full rounded-lg border-gray-300 text-sm" placeholder="CK-01" />
                    </div>
                </div>
