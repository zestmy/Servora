<div>
    ...
    <div x-data="{ open: false }" class="mb-4">
        <button @click="open = !open" class="flex items-center gap-2 text-xs text-brand-600 hover:text-brand-800 font-medium transition">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                @if ($hasChildren)
                                    <button @click="open = !open"
                                            class="text-xs text-gray-600 hover:text-gray-900 flex items-center gap-1 transition">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-2">
                                <button wire:click="openCreateSub({{ $cat->id }})" title="Add Sub-Category"
                                        class="text-xs px-2 py-1 bg-warning-50 text-warning-600 rounded hover:bg-warning-100 transition font-medium">
                                    + Sub
                                </button>
                            ...
                            <tr x-show="open" x-cloak class="bg-gray-50/50 hover:bg-gray-100/60 transition border-l-4" style="border-left-color: {{ $cat->color }}">
                                <td class="pl-10 pr-4 py-2.5">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-xs text-gray-600">↳ sub of {{ $cat->name }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-2.5">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <button wire:click="toggleActive({{ $sub->id }})"
                                                ...
                                                class="{{ $sub->is_active ? 'text-success-500 hover:text-success-700' : 'text-gray-600 hover:text-gray-900' }} transition">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                        </button>
