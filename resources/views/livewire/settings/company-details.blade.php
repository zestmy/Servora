    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-600 mt-0.5">These details appear on PO, DO and GRN documents</p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-600 mt-1">Displayed on the Training Portal. Defaults to company name if empty.</p>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-600 mt-1">Used in your Training Portal URL. Lowercase letters, numbers and dashes only.</p>
                ...
                @if ($slug)
                    ...
                    <div class="bg-brand-50 border border-brand-200 rounded-lg p-4">
                        <h4 class="text-xs font-semibold text-brand-800 uppercase tracking-wider mb-2">Training Portal URLs</h4>
                        <div class="space-y-2">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-xs text-brand-600 font-medium">Staff Login (Subdomain)</p>
                                    <p class="text-sm text-brand-900 font-mono">https://{{ $slug }}.{{ $appDomain }}/lms/login</p>
                                </div>
                                <a href="https://{{ $slug }}.{{ $appDomain }}/lms/login" target="_blank"
                                   class="text-brand-500 hover:text-brand-700 transition" title="Open">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-xs text-brand-600 font-medium">Staff Registration</p>
                                    <p class="text-sm text-brand-900 font-mono">https://{{ $slug }}.{{ $appDomain }}/lms/register</p>
                                </div>
                        ...
                        <p class="text-[10px] text-brand-500 mt-3">Share these links with your staff to access SOPs and training materials.</p>
                    </div>
                @endif
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-600 mt-1">Used on purchase documents. Defaults to registered address if empty.</p>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600 mt-1">LMS trainees see timestamps in this zone.</p>
                ...
                <div class="border-t border-gray-100 pt-4">
                    ...
                    <p class="text-xs text-gray-600 mt-2">Applied automatically to purchase orders.</p>
                </div>
                ...
                <div class="border-t border-gray-100 pt-4">
                    ...
                    <p class="text-xs text-gray-600 mt-1">When disabled, unit cost and totals are hidden on Delivery Order and GRN forms and PDFs. Pricing data is still recorded internally.</p>
                </div>
                ...
                <div class="border-t border-gray-100 pt-4">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="text-xs text-gray-600 mt-1">When enabled, a Delivery Order and GRN will be automatically created when a Purchase Order is approved.</p>
                        </div>
                        <div>
                            <label class="inline-flex items-center gap-2 cursor-pointer">
                            ...
                            <p class="text-xs text-gray-600 mt-1">When enabled, approved POs are emailed directly to the supplier (with PDF attached). No DO generation is needed — the supplier delivers based on the PO.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-100 pt-4">
                    ...
                    <p class="text-xs text-gray-500 mb-3">Once Products or Recipes are finalized, lock them so only company admins can create, edit, import, delete, or reorder. Everyone else sees the lists in read-only mode.</p>
                    <div class="space-y-3">
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" wire:model="ingredients_locked"
                                   class="rounded border-gray-300 text-brand-600 shadow-sm focus:ring-brand-500" />
                            <span class="text-sm text-gray-700">Lock Market List</span>
                        </label>
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                ...
                <div class="border-t border-gray-100 pt-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600 mt-1">Comma-separated emails to CC on all PO approval emails. The supplier, approver, and creator are included automatically.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div>
                        ...
                        @if ($logo)
                            <p class="text-xs text-success-600 mt-2">New logo selected. Save to apply.</p>
                        @endif
                    </div>
                </div>
