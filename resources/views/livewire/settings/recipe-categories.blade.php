                ...
                @forelse ($categories as $cat)
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-2">
                                <button wire:click="openCreate({{ $cat->id }})" title="Add Sub-category"
                    ...
                    @foreach ($cat->children as $sub)
                        <tr class="hover:bg-gray-50/50 transition bg-gray-50/30">
                            ...
                            <td class="px-4 py-2.5 text-center text-gray-400 text-xs">{{ $sub->sort_order }}</td>
                            <td class="px-4 py-2.5 text-center text-gray-600">
                                {{ $recipeCounts[$sub->name] ?? 0 }}
                            </td>
                            ...
                            <td class="px-4 py-2.5">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button wire:click="delete({{ $sub->id }})"
                                            wire:confirm="Delete sub-category '{{ $sub->name }}'?"
                                            title="Delete"
                                            class="text-red-400 hover:text-red-600 transition">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
