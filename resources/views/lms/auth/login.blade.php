        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                @if ($company->brand_name && $company->name !== $company->brand_name)
                    <p class="text-xs text-gray-600 mt-0.5">{{ $company->name }}</p>
                @endif
            </div>

            {{-- Flash messages --}}
            @if (session('success'))
                <div class="mb-4 px-4 py-3 bg-success-50 border border-success-200 text-success-700 text-sm rounded-lg">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <div class="bg-white shadow-sm rounded-xl border border-gray-200 p-8">
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-500">
                        ...
                        <a href="{{ route('lms.register', $company->slug) }}" class="text-brand-600 hover:underline font-medium">Register here</a>
                    </p>
                </div>
            </div>

            <p class="text-center text-xs text-gray-600 mt-6">Powered by Servora</p>
        </div>
    </div>
</body>
</html>
